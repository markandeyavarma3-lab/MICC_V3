...
| 1.4 | Trading calendar from observed sessions | **VERIFIED** | 5367 observed sessions; 3 of them are Saturdays a generated calendar would drop |
...
| 1.8 | Price spine, ADJUSTED spine, PIT universe | **VERIFIED** | adjusted spine reaches 2026-09-24; PIT universe still missing |
...
| 1.10 | Close Risk 8 — off-machine backup with a watched restore | **VERIFIED** | newest 2026-09-25 04:21 UTC, 4 generation(s), 0 commit(s) and 0 archived session(s) not in it; static 9.1 GB verified at iCloud 2026-09-17 |
...
| 2.8 | participant_oi ported as the FII/DII proxy | **VERIFIED** | 15,674 rows, 2014-01-01 .. 2026-06-25; positioning, not cash flow (sources.yml) |
| 2.9 | Scheduled collection running | **VERIFIED** | launchd added 2026-08-22 after cron silently lost the 19 Aug session |
| 2.12 | Daily PRICE feed, so collected deals are usable | **VERIFIED** | price_spine reaches 2026-09-24; MICCV2 stopped at 2026-08-14 |
