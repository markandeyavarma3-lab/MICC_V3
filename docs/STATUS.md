...
| 1.10 | Close Risk 8 — off-machine backup with a watched restore | **VERIFIED** | newest 2026-09-01 05:01 UTC, 1 generation(s), 0 commit(s) and 0 archived session(s) not in it |
...
| 2.12 | Daily PRICE feed, so collected deals are usable | **VERIFIED** | price_spine reaches 2026-08-31; MICCV2 stopped at 2026-08-14 |
