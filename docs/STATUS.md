...
| 1.10 | Close Risk 8 — off-machine backup with a watched restore | **VERIFIED** | newest 2026-09-10 17:04 UTC, 29 generation(s), 1 commit(s) and 0 archived session(s) not in it |
...
| 3.7 | Behavioural PROP_HFT classifier | WIRED | tags 168 of 239,480 deals (0.07%). The exclusion credited to this classifier is done by the same-day round-trip flag — 147,116 deals, 61% — so Graviton, HRT, Tower and XTX survive it. VERIFIED describes the code, not the coverage (0056 amendment 2) |
