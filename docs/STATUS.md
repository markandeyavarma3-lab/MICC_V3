...
| 1.4 | Trading calendar from observed sessions | **VERIFIED** | 5362 observed sessions; 3 of them are Saturdays a generated calendar would drop |
...
| 1.10 | Close Risk 8 — off-machine backup with a watched restore | WIRED | newest 2026-09-18 05:23 UTC, 4 generation(s), 10 commit(s) and 1078 archived session(s) not in it; static 9.1 GB verified at iCloud 2026-09-17 |
