...
Status at 2026-09-02 05:48 UTC: all sources current
...
|---|---|---:|---|---|
| `nse_bulk_deals` | 2026-09-01 | 1 | yes | ok |
| `nse_block_deals` | 2026-09-01 | 1 | yes | ok |
| `fii_dii_cash` | 2026-09-01 | 1 | no | ok |

Alert threshold: 2 missed trading sessions.

## Off-machine backup

current — newest 2026-09-01 20:30 UTC, 3 generation(s), 0 commit(s) and 0 archived session(s) not in it
