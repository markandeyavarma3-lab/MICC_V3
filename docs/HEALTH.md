...
Status at 2026-09-16 05:27 UTC: **1 SOURCE(S) STALE**
...
|---|---|---:|---|---|
| `nse_bulk_deals` | 2026-09-15 | 1 | yes | 2 lost (acknowledged) |
| `nse_block_deals` | 2026-09-11 | 3 | yes | 4 lost (acknowledged) |
| `nse_participant_oi` | 2026-09-15 | 1 | yes | ok |
| `nse_fo_bhavcopy` | 2026-09-15 | 1 | yes | ok |
| `fii_dii_cash` | 2026-09-15 | 1 | no | 2 lost (acknowledged) |
...
current — newest 2026-09-16 03:06 UTC, 27 generation(s), 4 commit(s) and 0 archived session(s) not in it
