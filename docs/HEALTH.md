...
Status at 2026-09-16 15:43 UTC: all sources current
...
|---|---|---:|---|---|
| `nse_bulk_deals` | 2026-09-16 | 0 | yes | 2 lost (acknowledged) |
| `nse_block_deals` | 2026-09-16 | 0 | yes | 5 lost (acknowledged) |
| `nse_participant_oi` | 2026-09-16 | 0 | yes | ok |
| `nse_fo_bhavcopy` | 2026-09-16 | 0 | yes | ok |
| `fii_dii_cash` | 2026-09-16 | 0 | no | 2 lost (acknowledged) |
...
current — newest 2026-09-16 15:03 UTC, 3 generation(s), 1 commit(s) and 0 archived session(s) not in it
