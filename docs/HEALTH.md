...
Status at 2026-09-16 15:02 UTC: **2 SOURCE(S) STALE**
...
| `nse_block_deals` | 2026-09-16 | 0 | yes | **1 MISSING** |
...
**AT RISK** — newest 2026-09-16 03:06 UTC, 3 generation(s), 15 commit(s) and 6 archived session(s) not in it
