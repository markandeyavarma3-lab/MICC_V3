...
Status at 2026-09-10 12:41 UTC: **1 SOURCE(S) STALE**
...
|---|---|---:|---|---|
| `nse_bulk_deals` | 2026-09-09 | 1 | yes | 2 lost (acknowledged) |
| `nse_block_deals` | 2026-09-04 | 4 | yes | 1 lost (acknowledged) |
| `fii_dii_cash` | 2026-09-09 | 1 | no | 1 lost (acknowledged) |
...
current — newest 2026-09-10 04:47 UTC, 26 generation(s), 0 commit(s) and 0 archived session(s) not in it
