...
Status at 2026-09-10 17:04 UTC: **1 SOURCE(S) STALE**
...
|---|---|---:|---|---|
| `nse_bulk_deals` | 2026-09-10 | 0 | yes | 2 lost (acknowledged) |
| `nse_block_deals` | 2026-09-04 | 4 | yes | 1 lost (acknowledged) |
| `fii_dii_cash` | 2026-09-10 | 0 | no | 1 lost (acknowledged) |
...
current — newest 2026-09-10 17:02 UTC, 28 generation(s), 0 commit(s) and 0 archived session(s) not in it
