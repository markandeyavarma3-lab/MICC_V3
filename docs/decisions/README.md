...
| [0059](0059-two-sessions-lost-to-a-shutdown-and-one-scheduler.md) | **Two sessions lost to a shutdown, and one scheduler where there were two** — machine off Fri 17:19 → Tue 09:33 IST, 2026-09-11 and 2026-09-14 bulk/block/FII-DII acknowledged; cron retired, launchd is the only trigger, the double-fire that collided on DuckDB locks is gone | 2026-09-15 | ACTIVE |
