...
This is the substantial achievement so far. 683 automated tests, all passing.
...
Seventy-one decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 683 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-one decision records with reversal conditions
