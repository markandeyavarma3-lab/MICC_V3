...
This is the substantial achievement so far. 396 automated tests, all passing.
...
Forty-four decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 396 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Forty-four decision records with reversal conditions
