...
This is the substantial achievement so far. 489 automated tests, all passing.
...
Fifty-five decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 489 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty-five decision records with reversal conditions
