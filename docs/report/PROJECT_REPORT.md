...
This is the substantial achievement so far. 500 automated tests, all passing.
...
Fifty-six decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 500 tests that enforces honest research
