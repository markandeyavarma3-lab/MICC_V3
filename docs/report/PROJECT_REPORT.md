...
This is the substantial achievement so far. 637 automated tests, all passing.
...
Sixty-nine decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 637 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Sixty-nine decision records with reversal conditions
