...
This is the substantial achievement so far. 684 automated tests, all passing.
...
Seventy-two decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 684 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-two decision records with reversal conditions
