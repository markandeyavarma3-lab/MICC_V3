...
This is the substantial achievement so far. 789 automated tests, all passing.
...
Seventy-five decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 789 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-five decision records with reversal conditions
