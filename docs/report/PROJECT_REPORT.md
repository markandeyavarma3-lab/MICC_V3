...
This is the substantial achievement so far. 451 automated tests, all passing.
...
Fifty decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 451 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty decision records with reversal conditions
