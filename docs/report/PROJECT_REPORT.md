...
This is the substantial achievement so far. 473 automated tests, all passing.
...
Fifty-three decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 473 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty-three decision records with reversal conditions
