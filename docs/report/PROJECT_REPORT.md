...
This is the substantial achievement so far. 636 automated tests, all passing.
...
Sixty-eight decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 636 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Sixty-eight decision records with reversal conditions
