...
This is the substantial achievement so far. 458 automated tests, all passing.
...
Fifty-one decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 458 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty-one decision records with reversal conditions
