...
This is the substantial achievement so far. 487 automated tests, all passing.
...
Fifty-four decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 487 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty-four decision records with reversal conditions
