...
This is the substantial achievement so far. 720 automated tests, all passing.
...
Seventy-four decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 720 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-four decision records with reversal conditions
