...
This is the substantial achievement so far. 648 automated tests, all passing.
...
Seventy decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 648 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy decision records with reversal conditions
