...
This is the substantial achievement so far. 392 automated tests, all passing.
...
Forty-three decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 392 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Forty-three decision records with reversal conditions
