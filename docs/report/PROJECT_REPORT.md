...
company has **5.5 years** of prices, and only 540 of 4,200 have twenty.
...
This is the substantial achievement so far. 838 automated tests, all passing.
...
Seventy-seven decision records, each recording what was decided, by whom, why, **what
...
| 63 sessions (3 months) | 1.8540% | 1.50% | 1.23× short |
...
- A discipline framework with 838 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-seven decision records with reversal conditions
