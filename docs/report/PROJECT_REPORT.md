...
This is the substantial achievement so far. 709 automated tests, all passing.
...
Seventy-three decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 709 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-three decision records with reversal conditions
