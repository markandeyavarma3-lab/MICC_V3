...
This is the substantial achievement so far. 369 automated tests, all passing.
...
Thirty-nine decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 369 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Thirty-nine decision records with reversal conditions
