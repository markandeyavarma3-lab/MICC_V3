...
This is the substantial achievement so far. 823 automated tests, all passing.
...
Seventy-six decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 823 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Seventy-six decision records with reversal conditions
