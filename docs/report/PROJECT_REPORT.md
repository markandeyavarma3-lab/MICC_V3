...
This is the substantial achievement so far. 466 automated tests, all passing.
...
Fifty-two decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 466 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Fifty-two decision records with reversal conditions
