...
This is the substantial achievement so far. 444 automated tests, all passing.
...
Forty-nine decision records, each recording what was decided, by whom, why, **what
...
- A discipline framework with 444 tests that enforces honest research
- One complete experiment, correctly rejected by its own pre-registered rule
- Forty-nine decision records with reversal conditions
